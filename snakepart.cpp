...
void SnakePart::setImage() {
    if(part == "HEAD"){
        ...
        if(direction == "UP"){
          setPixmap(QPixmap("C:/Qt/Snake_game/headup.png").scaled(40,40));
        }else if(direction == "DOWN"){
           setPixmap(QPixmap("C:/Qt/Snake_game/headDown.png").scaled(40,40));
        }else if(direction == "LEFT"){
            setPixmap(QPixmap("C:/Qt/Snake_game/headLeft.png").scaled(40,40));
        }else if(direction == "RIGHT"){
            setPixmap(QPixmap("C:/Qt/Snake_game/head.png").scaled(40,40,Qt::KeepAspectRatio));
        }
        setZValue(2);
        ...
        if(direction == "UP"){
          setPixmap(QPixmap("C:/Qt/Snake_game/tailUp.png").scaled(40,40));
        }else if(direction == "DOWN"){
           setPixmap(QPixmap("C:/Qt/Snake_game/tailDown.png").scaled(40,40));
        }else if(direction == "LEFT"){
            setPixmap(QPixmap("C:/Qt/Snake_game/tailLeft.png").scaled(40,40));
        }else if(direction == "RIGHT"){
            setPixmap(QPixmap("C:/Qt/Snake_game/tail.png").scaled(40,40));
        }
    }
    else if (part == "PART"){
        if(direction == this->backward->getDirection()){
        if(direction == "LEFT" ||direction ==  "RIGHT")
            setPixmap(QPixmap("C:/Qt/Snake_game/left-right.png").scaled(40,40));
        else if (direction == "UP" || direction == "DOWN")
            setPixmap(QPixmap("C:/Qt/Snake_game/up-down.png").scaled(40,40));

        }
        else{
            if((direction == "UP" && this->backward->getDirection() == "LEFT")
                    || (direction == "RIGHT" && this->backward->getDirection() == "DOWN"))
                setPixmap(QPixmap("C:/Qt/Snake_game/leftUp-downRight.png").scaled(40,40));
            else if((direction == "UP" && this->backward->getDirection() == "RIGHT")
                    || (direction == "LEFT" && this->backward->getDirection() == "DOWN"))
                setPixmap(QPixmap("C:/Qt/Snake_game/rightUp-downLeft.png").scaled(40,40));
            else if((direction == "LEFT" && this->backward->getDirection() == "UP")
                    || (direction == "DOWN" && this->backward->getDirection() == "RIGHT"))
                setPixmap(QPixmap("C:/Qt/Snake_game/upLeft-rightDown.png").scaled(40,40));
            else
                setPixmap(QPixmap("C:/Qt/Snake_game/upRight-leftDown.png").scaled(40,40));
